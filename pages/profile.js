...
export default class user extends React.Component{
    constructor(props){
     ...
     renderActionButtons = () =>{
                 return (<>
                  {/* BUTTON */}
                  <Link href="/manage/profile?action=edit"><a className="profile-header-info-action button secondary">Edit Profile</a></Link>
                  {/* /BUTTON */}
                  {/* BUTTON */}
                  <p className="profile-header-info-action button secondary">Settings</p>
                  {/* /BUTTON */}
                 </>)  
      }
            ...
            <div className="profile-header">
              ...
              <div className="profile-header-info">
                ...
                <div className="user-short-description big">
                  ...
                  <p className="user-short-description-title">{this.state.loggedInUser.niceName}</p>
                  {/* /USER SHORT DESCRIPTION TITLE */}
